...
Calculate.Data = (transactionDTO) => {
  const { ID, Amount, Currency, CustomerEmail, SplitInfo } = transactionDTO;
  ...
  allSplitTypes.forEach((element) => {
    const currentSplitInfo = element;
    const resObj = {};
